...
public class AngularLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INTERFACE", "FUNCTION", "CLASS", "IMPLEMENTS", "ROUTES", "SELECTOR", 
			...
			"THIS", "CONSOLE", "LOG", "CSS_IMPORT", "CSS_URL", "CSS_COLOR", "HEX", 
			"CSS_UNIT", "DIV", "BODY", "NAV", "SPAN", "P", "A", "BUTTON", "FORM", 
			"IMG", "INPUTTAG", "UL", "LI", "H1", "H2", "H3", "H4", "H5", "H6", "COLOR", 
			"BACKGROUND", "WIDTH", "HEIGHT", "MARGIN", "PADDING", "FONTSIZE", "DISPLAY", 
			"POSITION", "BORDER", "BOXSIZING", "HTML", "ALT", "HREF", "SRC", "DISABLED", 
			"TYPE", "ROUTER_LINK", "ROUTER_LINK_Active", "VALUE", "CHECKED", "CLICK", 
			"NG_SUBMIT", "CHANGE", "SUBMIT", "KEYDOWN", "KEYUP", "NGIF", "NGFOR", 
			"NGSWITCH", "NGMODEL", "ROUTE_COMPONENT", "PATH", "COMPONENT", "INJECTABLE", 
			"INPUT", "IDDEFINER", "NAME", "ID", "TITLE", "OPEN_TAG", "CLOSE_TAG", 
			"SELF_CLOSD", "OPEN_TAG_SLASH", "COMMA", "SEMI", "COLON", "DOT", "HASH", 
			"LPAREN", "RPAREN", "LCURLY", "RCURLY", "ASSIGN", "LBRACK", "RBRACK", 
			"DOLLAR", "PIPE", "PLUS", "MINUS", "STAR", "DIVISION", "PERCENT", "LE", 
			"GE", "EQ", "NEQ", "DEFINITE_ASSIGN", "PPLUS", "MMINUS", "SQ", "DQ", 
			"STRING", "NUMBER", "BOOL", "NULL", "DECORATOR"
		};
	}
