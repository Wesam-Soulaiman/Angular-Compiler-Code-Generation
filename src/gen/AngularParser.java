...
public class AngularParser extends Parser {
	...
	public static final int
		...
		INTERFACE=8, FUNCTION=9, CLASS=10, IMPLEMENTS=11, LOCALSTORAGE=12, ROUTES=13, 
		SELECTOR=14, TEMPLATE_URL=15, IMPORTS=16, STYLE_URLS=17, STYLE_URL=18, 
		PROVIDEDIN=19, CONST=20, LET=21, VAR=22, PUBLIC=23, PRIVATE=24, PROTECTED=25, 
		ANY_TYPE=26, STRING_TYPE=27, NUMBER_TYPE=28, BOOLEAN_TYPE=29, VOID_TYPE=30, 
		ARRAY=31, UNDEFINED=32, RETURN=33, THIS=34, CONSOLE=35, LOG=36, CSS_IMPORT=37, 
		CSS_URL=38, CSS_COLOR=39, CSS_UNIT=40, DIV=41, BODY=42, NAV=43, SPAN=44, 
		P=45, A=46, BUTTON=47, FORM=48, IMG=49, INPUTTAG=50, UL=51, LI=52, H1=53, 
		H2=54, H3=55, H4=56, H5=57, H6=58, COLOR=59, BACKGROUND=60, WIDTH=61, 
		HEIGHT=62, MARGIN=63, PADDING=64, FONTSIZE=65, DISPLAY=66, POSITION=67, 
		BORDER=68, BOXSIZING=69, HTML=70, ALT=71, HREF=72, SRC=73, DISABLED=74, 
		TYPE=75, ROUTER_LINK=76, ROUTER_LINK_Active=77, VALUE=78, CHECKED=79, 
		CLICK=80, NG_SUBMIT=81, CHANGE=82, SUBMIT=83, KEYDOWN=84, KEYUP=85, NGIF=86, 
		NGFOR=87, NGSWITCH=88, NGMODEL=89, ROUTE_COMPONENT=90, PATH=91, COMPONENT=92, 
		INJECTABLE=93, INPUT=94, IDDEFINER=95, NAME=96, ID=97, TITLE=98, OPEN_TAG=99, 
		CLOSE_TAG=100, SELF_CLOSD=101, OPEN_TAG_SLASH=102, COMMA=103, SEMI=104, 
		COLON=105, DOT=106, HASH=107, LPAREN=108, RPAREN=109, LCURLY=110, RCURLY=111, 
		ASSIGN=112, LBRACK=113, RBRACK=114, DOLLAR=115, PIPE=116, PLUS=117, MINUS=118, 
		STAR=119, DIVISION=120, PERCENT=121, LE=122, GE=123, EQ=124, NEQ=125, 
		DEFINITE_ASSIGN=126, PPLUS=127, MMINUS=128, SQ=129, DQ=130, STRING=131, 
		NUMBER=132, BOOL=133, NULL=134, DECORATOR=135;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'function'", "'class'", "'implements'", "'localStorage'", "'Routes'", 
			"'selector'", "'templateUrl'", "'imports'", "'styleUrls'", "'styleUrl'", 
			"'providedIn'", "'const'", "'let'", "'var'", "'public'", "'private'", 
			"'protected'", "'any'", "'string'", "'number'", "'boolean'", "'void'", 
			"'Array'", "'undefined'", "'return'", "'this'", "'console'", "'log'", 
			"'@import'", "'url'", null, null, "'div'", "'body'", "'nav'", "'span'", 
			"'p'", "'a'", "'button'", "'form'", "'img'", "'input'", "'ul'", "'li'", 
			"'h1'", "'h2'", "'h3'", "'h4'", "'h5'", "'h6'", "'color'", "'background'", 
			"'width'", "'height'", "'margin'", "'padding'", "'font-size'", "'display'", 
			"'position'", "'border'", "'box-sizing'", "'html'", "'alt'", "'href'", 
			"'src'", "'disabled'", "'type'", "'routerLink'", "'routerLinkActive'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ARROW", "INTERFACE", "FUNCTION", "CLASS", "IMPLEMENTS", "LOCALSTORAGE", 
			"ROUTES", "SELECTOR", "TEMPLATE_URL", "IMPORTS", "STYLE_URLS", "STYLE_URL", 
			"PROVIDEDIN", "CONST", "LET", "VAR", "PUBLIC", "PRIVATE", "PROTECTED", 
			"ANY_TYPE", "STRING_TYPE", "NUMBER_TYPE", "BOOLEAN_TYPE", "VOID_TYPE", 
			"ARRAY", "UNDEFINED", "RETURN", "THIS", "CONSOLE", "LOG", "CSS_IMPORT", 
			"CSS_URL", "CSS_COLOR", "CSS_UNIT", "DIV", "BODY", "NAV", "SPAN", "P", 
			"A", "BUTTON", "FORM", "IMG", "INPUTTAG", "UL", "LI", "H1", "H2", "H3", 
			"H4", "H5", "H6", "COLOR", "BACKGROUND", "WIDTH", "HEIGHT", "MARGIN", 
			"PADDING", "FONTSIZE", "DISPLAY", "POSITION", "BORDER", "BOXSIZING", 
			"HTML", "ALT", "HREF", "SRC", "DISABLED", "TYPE", "ROUTER_LINK", "ROUTER_LINK_Active", 
			"VALUE", "CHECKED", "CLICK", "NG_SUBMIT", "CHANGE", "SUBMIT", "KEYDOWN", 
			"KEYUP", "NGIF", "NGFOR", "NGSWITCH", "NGMODEL", "ROUTE_COMPONENT", "PATH", 
	...
	public final OpenCloseTagContext openCloseTag() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 95)) & ~0x3f) == 0 && ((1L << (_la - 95)) & 32785L) != 0)) {
				{
				{
				setState(243);
				elementContent();
	...
	public final StartTagContext startTag() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==CLASS || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 286010713833599L) != 0)) {
				{
				{
				setState(253);
				attribute();
	...
	public final AngularInterpolationContext angularInterpolation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 21474840576L) != 0) || ((((_la - 95)) & ~0x3f) == 0 && ((1L << (_la - 95)) & 1030792445953L) != 0)) {
				{
				setState(311);
		...
		try {
			...
			case DECORATOR:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 7341904L) != 0) || ((((_la - 95)) & ~0x3f) == 0 && ((1L << (_la - 95)) & 1099511635969L) != 0) );
				}
				break;
			case EOF:
	...
	public final NamedImportBlockContext namedImportBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==ROUTES || ((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 15L) != 0)) {
				{
				setState(420);
				namedImportContent();
				}
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7340096L) != 0) || _la==IDDEFINER || _la==DECORATOR) {
				{
				{
				setState(547);
				classMember();
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 64431853632L) != 0) || ((((_la - 95)) & ~0x3f) == 0 && ((1L << (_la - 95)) & 2130304073729L) != 0)) {
				{
				{
				setState(654);
				statement();
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 112)) & ~0x3f) == 0 && ((1L << (_la - 112)) & 993L) != 0)) {
				{
				{
				setState(783);
				arithmaticExpr();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class LocalLabelContext extends MemberAccessElementContext {
		public TerminalNode LOCALSTORAGE() { return getToken(AngularParser.LOCALSTORAGE, 0); }
		public LocalLabelContext(MemberAccessElementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AngularParserListener ) ((AngularParserListener)listener).enterLocalLabel(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AngularParserListener ) ((AngularParserListener)listener).exitLocalLabel(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AngularParserVisitor ) return ((AngularParserVisitor<? extends T>)visitor).visitLocalLabel(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final MemberAccessElementContext memberAccessElement() throws RecognitionException {
		...
		try {
			...
			case THIS:
				...
				break;
			case LOCALSTORAGE:
				_localctx = new LocalLabelContext(_localctx);
				enterOuterAlt(_localctx, 3);
				{
				setState(831);
				match(LOCALSTORAGE);
	...
	public final CssProgContext cssProg() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( _la==CSS_IMPORT || _la==BODY || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 563156145405953L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RuleSetContext ruleSet() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 59)) & ~0x3f) == 0 && ((1L << (_la - 59)) & 68719478783L) != 0)) {
				{
				{
				setState(912);
				declaration();
	...
	public static final String _serializedATN =
		...
		"\bW\u0001X\u0001X\u0001X\u0001X\u0001X\u0001Y\u0001Y\u0001Y\u0003Y\u0341"+
		"\bY\u0001Z\u0001Z\u0001Z\u0003Z\u0346\bZ\u0001Z\u0001Z\u0001[\u0001[\u0001"+
		"[\u0003[\u034d\b[\u0001[\u0001[\u0001\\\u0001\\\u0001\\\u0001\\\u0001"+
		"\\\u0001\\\u0003\\\u0357\b\\\u0001]\u0001]\u0001]\u0001^\u0001^\u0001"+
		"^\u0003^\u035f\b^\u0001_\u0001_\u0001_\u0004_\u0364\b_\u000b_\f_\u0365"+
		"\u0001`\u0001`\u0001`\u0001`\u0001`\u0001a\u0001a\u0001a\u0001a\u0001"+
		"a\u0001a\u0001a\u0003a\u0374\ba\u0001b\u0004b\u0377\bb\u000bb\fb\u0378"+
		"\u0001c\u0001c\u0003c\u037d\bc\u0001d\u0001d\u0001d\u0003d\u0382\bd\u0001"+
		"e\u0001e\u0003e\u0386\be\u0001f\u0001f\u0001g\u0001g\u0001g\u0001g\u0001"+
		"g\u0001h\u0001h\u0001h\u0005h\u0392\bh\nh\fh\u0395\th\u0001h\u0001h\u0001"+
		"i\u0001i\u0001i\u0005i\u039c\bi\ni\fi\u039f\ti\u0001i\u0003i\u03a2\bi"+
		"\u0001j\u0001j\u0001j\u0001j\u0001j\u0001j\u0003j\u03aa\bj\u0001k\u0001"+
		"k\u0001k\u0001l\u0001l\u0001l\u0001m\u0001m\u0001m\u0001m\u0001m\u0001"+
		"n\u0001n\u0001n\u0001n\u0001n\u0001n\u0001n\u0001n\u0001n\u0001n\u0001"+
		"n\u0001n\u0003n\u03c3\bn\u0001o\u0001o\u0001o\u0005o\u03c8\bo\no\fo\u03cb"+
		"\to\u0001o\u0003o\u03ce\bo\u0001p\u0001p\u0001p\u0001p\u0003p\u03d4\b"+
		"p\u0001q\u0001q\u0003q\u03d8\bq\u0001q\u0000\u0000r\u0000\u0002\u0004"+
		"\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e \""+
